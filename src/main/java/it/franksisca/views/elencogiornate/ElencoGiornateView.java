package it.franksisca.views.elencogiornate;
...
@PageTitle("Elenco Giornate")
@Menu(icon = "line-awesome/svg/th-solid.svg", order = 1)
@Route(value = "data-grid")
public class ElencoGiornateView extends Div {
    ...
    public ElencoGiornateView() {
        addClassName("elenco-giornate-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
