package it.franksisca.views.elencosquadre;
...
@PageTitle("Elenco Squadre")
@Menu(icon = "line-awesome/svg/teeth-open-solid.svg", order = 0)
@Route(value = "")
@RouteAlias(value = "")
public class ElencoSquadreView extends Div {
    ...
    public ElencoSquadreView() {
        addClassName("elenco-squadre-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
