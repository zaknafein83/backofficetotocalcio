package it.franksisca.views.giornataattuale;
...
@PageTitle("Giornata Attuale")
@Menu(icon = "line-awesome/svg/list-solid.svg", order = 2)
@Route(value = "feed")
public class GiornataAttualeView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public GiornataAttualeView() {
        addClassName("giornata-attuale-view");
        setSizeFull();
        grid.setHeight("100%");
